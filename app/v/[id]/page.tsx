...
export async function generateMetadata(
    ...
    const description = `${file.title} di ${SITENAME} Video Bokep Indo Jepang Barat Terbaru bocil jilbab smp mama sma hijab abg`;
...
export default async function Video({ params }: PageProps) {
	...
	const jsonLd = {
        ...
        description: `${file.title} di ${SITENAME} Video Bokep Indo Jepang Barat Terbaru bocil jilbab smp mama sma hijab abg`,
        url: `https://bokepperawan.pages.dev/v/${file.filecode}`,
        ...
        publisher: {
            '@type': 'Organization',
            name: `${SITENAME}`,
            logo: 'https://bokepperawan.pages.dev/favicon.ico'},
            author: {
                '@type': 'Person',
                name: 'admin',
...
<meta itemProp="description" content={`${file.title} di ${SITENAME} Video Bokep Indo Jepang Barat Terbaru bocil jilbab smp mama sma hijab abg`} />
